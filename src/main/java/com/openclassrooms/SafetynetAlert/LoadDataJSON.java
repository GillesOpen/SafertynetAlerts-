...
public class LoadDataJSON {
	...
	public boolean loadMedicalRecords(String url) {
		...
		for (int i = 0; i < medicalRecords.size(); i++) {
			...
			if (medicalRecord0.get("medications").toString().equals("[]")
					|| medicalRecord0.get("allergies").toString().equals("[]")) {
	...
	/**
	 * Remise à zéro des Arrays dans les classe Persons / FireStations /
	 * MedicalRecord
	 **/
